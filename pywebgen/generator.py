"""
PyWebGen Project Generator

Creates standalone Flask projects that are completely independent.
The generated project does NOT depend on pywebgen package.
"""
...
def get_requirements_txt(project_name: str) -> str:
    return f"""# {project_name} - Flask Web Application
Flask>=3.0.0
...
error:
  ...
  file_upload: "Error al subir archivo"
...
def get_models_py(project_name: str) -> str:
    return f'''"""
Database Models
...
def _register_blueprints(app: Flask) -> None:
    ...
    from routes.custom import custom_bp  # For manual routes
...
# Due to length, I'll write the rest to a file

def create_project(project_name: str, project_path: Path) -> None:
    """Create a new standalone PyWebGen project."""
    from pywebgen.generator_templates2 import write_all_templates
    ...
    # Write all templates
    write_all_templates(project_name, project_path)
